...
class UrlEncodedTypeEncoderTest extends AbstractTypeEncoderTest
{
    ...
    public function testInvalidValueAsString()
    {
        ...
        $urlEncodedTransformer = new UrlEncodedTypeEncoder();
        $urlEncodedTransformer->encode(['key' => new \stdClass()]);
    }
}
