...
/**
 * @covers \Chubbyphp\Serialization\Serializer\Field\CollectionFieldSerializer
 */
class CollectionFieldSerializerTest extends \PHPUnit_Framework_TestCase
{
    public function testSerializeField()
    {
        ...
        $serializer = new CollectionFieldSerializer($this->getAccessor([new \stdClass()]));
